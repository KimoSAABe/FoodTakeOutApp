                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          AddBtnView(restroName: "Namma Veedu Vasanta Bhavan",foodName: foods[index].title, foodPrice: foods[index].price,)
                        ],
                      )
                    ],
                  ),
...
class AddBtnView extends StatelessWidget {
  ...
  String foodPrice;
  AddBtnView({
    Key key,this.restroName, this.foodName, this.foodPrice
  }) : super(key: key);


  @override
  Widget build(BuildContext context) {
    //final pdt = Provider.of<RestaurantDetail>(context);
    //final cart = Provider.of<OrderMenu>(context);
